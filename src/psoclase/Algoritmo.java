...
public class Algoritmo {
    ...
    //conficientes de aceleracion
    public static double C1 = 2.0; // 
    public static double C2 = 2.0; //
    //peso de la inercia 
    public static double W_UPPERBOUND = 1.0; //alto  ->peso de atraccion
    public static double W_LOWERBOUND = 0.0; //bajo  ->peso de atraccion

    //flag para minimizacion y maximizacion
    ...
    private double[] pBest = new double[SWARM_SIZE]; //mejores globales
    private Vector<Location> pBestLocation = new Vector<Location>(); //mejores locales
    public double gBest; //mejor global
    public Location gBestLocation; //mejor local
    ...
    /**
     * Paso 4: Actualiza la velocidad y la posicion de cada particula
     *
     * @param t
     */
    public void updateVelocityAndLocationOfParticle(int t) {
        ...
        for (int i = 0; i < SWARM_SIZE; i++) {
            //son variables aleatorias independientes distribuidas uniformemente en el rango 0-1
            ...
            for (int d = 0; d < this.dimensions.size(); d++) {
                //actualiza velocidad
                //es el resultado de la inercia +influencia cognitiva + la influencia social
